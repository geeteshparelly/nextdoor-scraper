...
| **Lead Scoring** | 🔥 HOT / 🟡 WARM / ⚪ COLD ratings |
...
| Score | Meaning |
|-------|---------|
| 🔥 HOT | No website + active + has contact info |
| 🟡 WARM | Bad/outdated website OR missing contact |
| ⚪ COLD | Has decent website (skip these) |
...
├── MEMORY.md            # Lead state tracking
│
├── playbooks/           # Platform-specific guides
│   ├── nextdoor.md
│   ├── yelp.md
│   ├── google-maps.md
│   ├── qualification.md
...
| Getting blocked | Slow down — max 20-30 per session |

---

## 🏆 TIPS FOR SUCCESS

1. **Start local** — Your city first
2. **Pick one industry** — Master it, then expand
3. **Personalize** — Templates are starting points
4. **Follow up** — Most deals close on attempt 2-4
5. **Track everything** — Update pipeline after every action
